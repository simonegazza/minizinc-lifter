...
public class FlatZincLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
				"PREDICATE", "ARRAY", "OF", "VAR", "BOOL", "INT", "FLOAT", "SET", "CONSTRAINT",
				"SOLVE", "SATISFY", "MINIMIZE", "MAXIMIZE", "TRUE", "FALSE", "LPAREN",
				"RPAREN", "LBRACK", "RBRACK", "LBRACE", "RBRACE", "COLON", "SEMI", "COMMA",
				"ASSIGN", "RANGE", "DCOLON", "INT_LITERAL", "FLOAT_LITERAL", "STRING_LITERAL",
