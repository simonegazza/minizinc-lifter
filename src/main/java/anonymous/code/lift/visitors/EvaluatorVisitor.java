...
import anonymous.code.antlr.minizinc.MiniZincParser.AddExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.AndExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.ArrayAccessTailContext;
import anonymous.code.antlr.minizinc.MiniZincParser.ArrayLiteral2dContext;
import anonymous.code.antlr.minizinc.MiniZincParser.ArrayLiteralContext;
import anonymous.code.antlr.minizinc.MiniZincParser.CallSuffixContext;
import anonymous.code.antlr.minizinc.MiniZincParser.CompareExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.EnumCasesContext;
import anonymous.code.antlr.minizinc.MiniZincParser.EnumCasesListContext;
import anonymous.code.antlr.minizinc.MiniZincParser.ExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.GeneratorContext;
import anonymous.code.antlr.minizinc.MiniZincParser.GeneratorListContext;
import anonymous.code.antlr.minizinc.MiniZincParser.IdentContext;
import anonymous.code.antlr.minizinc.MiniZincParser.IfThenElseExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.IffExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.ImplExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.LiteralContext;
import anonymous.code.antlr.minizinc.MiniZincParser.MultExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.OrExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.PostfixContext;
import anonymous.code.antlr.minizinc.MiniZincParser.PowExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.PrimaryContext;
import anonymous.code.antlr.minizinc.MiniZincParser.QuantifierExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.RangeExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.SetExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.SetLiteralContext;
import anonymous.code.antlr.minizinc.MiniZincParser.UnaryExprContext;
import anonymous.code.antlr.minizinc.MiniZincParser.XorExprContext;
import anonymous.code.lift.expressions.MiniZincArray;
import anonymous.code.lift.expressions.MiniZincSet;
